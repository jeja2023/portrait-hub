...
The 0.18.3 CI delivery patch updates the current release pointer and repository verification without changing requirement acceptance or production blockers. Its Docker context, SARIF upload and GitHub Actions runtime fixes are documented in `docs/releases/0.18.3.md`.
