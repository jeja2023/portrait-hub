...
当前版本：0.12.1。本补丁版本收口环境配置同步、Console Next 资源缓存、路由滚动恢复和页面标题栏展示问题，兼容 0.12.0 的 API、部署和数据。
