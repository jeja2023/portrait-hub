...
当前版本：0.18.0。本功能版本在多项目结构化解析平台之上补齐商业客户生命周期、授权许可、不可变计量与成本治理、模型发布、反馈数据闭环、视频续传、Webhook 投递、Kubernetes 交付、合规证据和商业运营控制台。仓库实现与自动化门禁已完成；真实模型、目标集群演练、生产容量观测及法律/产品审批仍是正式生产切换的前置条件。
