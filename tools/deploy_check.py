...
def check_required_files(root: Path, report: DeployReport) -> None:
    required = [
        ...
        "tools/portrait_sdk_clean_smoke.py",
        "tools/openapi_compatibility_check.py",
        ...
        "docs/deployment/API_COMPATIBILITY.md",
        ...
        "docs/operations/IDEMPOTENCY.md",
